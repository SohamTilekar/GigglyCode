...
class Compiler {
  ...
  private:
    ...
    std::tuple<std::vector<llvm::Value*>, std::shared_ptr<enviornment::RecordStructType>> _visitInfixExpression(
    ...
    std::tuple<std::vector<llvm::Value*>, std::shared_ptr<enviornment::RecordStructType>> _visitCallExpression(std::shared_ptr<AST::CallExpression>);
