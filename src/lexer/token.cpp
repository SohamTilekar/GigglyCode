...
std::string token::tokenTypeString(TokenType type) {
    ...
    switch (type) {
        ...
        case TokenType::DashEqual:          return "DashEqual";
        ...
        case TokenType::ForwardSlashEqual:  return "ForwardSlashEqual";
        case TokenType::BackwardSlashEqual: return "BackwardSlashEqual";
        ...
        case TokenType::AsteriskAsterisk:   return "AsteriskAsterisk";
        ...
        case TokenType::AtTheRate:          return "AtTheRate";
        ...
        case TokenType::NotBreak:           return "NotBreak";
        case TokenType::IfBreak:            return "IfBreak";
