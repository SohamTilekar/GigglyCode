...
entry:
  ...
  %self1 = alloca ptr, align 4
  store ptr %self, ptr %self1, align 4
  %_other2 = alloca ptr, align 4
  store ptr %_other, ptr %_other2, align 4
  %6 = load ptr, ptr %self1, align 4
  %accesedX_from_Point = getelementptr inbounds %main.gc..Point.0, ptr %6, i32 0, i32 0
  %7 = load ptr, ptr %_other2, align 4
  %accesedX_from_Point3 = getelementptr inbounds %main.gc..Point.0, ptr %7, i32 0, i32 0
  %8 = load i64, ptr %accesedX_from_Point, align 8
  %9 = load i64, ptr %accesedX_from_Point3, align 8
  %10 = sub i64 %8, %9
  store i64 %10, ptr %5, align 8
  %11 = load ptr, ptr %self1, align 4
  %accesedY_from_Point = getelementptr inbounds %main.gc..Point.0, ptr %11, i32 0, i32 1
  %12 = load ptr, ptr %_other2, align 4
  %accesedY_from_Point4 = getelementptr inbounds %main.gc..Point.0, ptr %12, i32 0, i32 1
  %13 = load i64, ptr %accesedY_from_Point, align 8
  %14 = load i64, ptr %accesedY_from_Point4, align 8
  %15 = sub i64 %13, %14
...
entry:
  %self1 = alloca ptr, align 4
  store ptr %self, ptr %self1, align 4
  %bottomLeft2 = alloca ptr, align 4
  store ptr %bottomLeft, ptr %bottomLeft2, align 4
  %topLeft3 = alloca ptr, align 4
  store ptr %topLeft, ptr %topLeft3, align 4
  %0 = load ptr, ptr %self1, align 4
  %accesedbottomLeft_from_Square = getelementptr inbounds %main.gc..Square.1, ptr %0, i32 0, i32 0
  %1 = load ptr, ptr %bottomLeft2, align 4
  store ptr %1, ptr %accesedbottomLeft_from_Square, align 4
  %2 = load ptr, ptr %self1, align 4
  %accesedtopLeft_from_Square = getelementptr inbounds %main.gc..Square.1, ptr %2, i32 0, i32 1
  %3 = load ptr, ptr %topLeft3, align 4
  store ptr %3, ptr %accesedtopLeft_from_Square, align 4
  ret void
}
...
entry:
  ...
  %2 = load ptr, ptr %accesedbottomLeft_from_Square, align 4
  %3 = load ptr, ptr %accesedtopLeft_from_Square, align 4
...
entry:
  ...
  store ptr %Square, ptr %0, align 4
