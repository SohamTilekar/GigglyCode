...
entry:
  ...
  store ptr %LinkedList1, ptr %1, align 8
  ...
  %6 = load ptr, ptr %accesedhead_from_LinkedList, align 8
...
body:                                             ; preds = %cond
  ...
  %10 = load i64, ptr %accesedvalue_from_ListNode, align 4
  ...
  %13 = load ptr, ptr %accesednext_from_ListNode, align 8
...
entry:
  ...
  store i64 %value, ptr %value2, align 4
  %next3 = alloca ptr, align 8
  store ptr %next, ptr %next3, align 8
  %0 = load ptr, ptr %self1, align 8
  %accesedvalue_from_ListNode = getelementptr inbounds %main.gc..ListNode.0, ptr %0, i32 0, i32 0
  %1 = load i64, ptr %value2, align 4
  store i64 %1, ptr %accesedvalue_from_ListNode, align 4
  ...
  store ptr %3, ptr %accesednext_from_ListNode, align 8
  ret void
}
...
entry:
  ...
  store ptr null, ptr %accesedhead_from_LinkedList, align 8
  ret void
}
...
then:                                             ; preds = %entry
  ...
  store ptr %8, ptr %accesedhead_from_LinkedList3, align 8
  br label %cont
...
cont:                                             ; preds = %cont5, %then
  ...
  %10 = load ptr, ptr %accesedhead_from_LinkedList4, align 8
...
cond:                                             ; preds = %body, %else
  ...
  %12 = load ptr, ptr %accesednext_from_ListNode, align 8
...
body:                                             ; preds = %cond
  ...
  %15 = load ptr, ptr %accesednext_from_ListNode6, align 8
...
cont5:                                            ; preds = %cond
  ...
  store ptr %17, ptr %accesednext_from_ListNode7, align 8
  br label %cont
}
