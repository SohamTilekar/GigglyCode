...
entry:
  ...
  %3 = load i64, ptr %accesedy_from_Point, align 4
  %4 = add i64 %2, %3
  ret i64 %4
}
...
entry:
  ...
  store i64 %cx, ptr %cx2, align 4
  %cy3 = alloca i64, align 8
  store i64 %cy, ptr %cy3, align 4
  %r4 = alloca i64, align 8
  store i64 %r, ptr %r4, align 4
  %0 = load i64, ptr %cx2, align 4
  %1 = load i64, ptr %cy3, align 4
  ...
  store ptr %Point, ptr %accesedcenter_from_Circle, align 8
  %3 = load ptr, ptr %self1, align 8
  %accesedradius_from_Circle = getelementptr inbounds %main.gc..Circle.1, ptr %3, i32 0, i32 1
  %4 = load i64, ptr %r4, align 4
  store i64 %4, ptr %accesedradius_from_Circle, align 4
  ret void
}
...
entry:
  ...
  %1 = load i64, ptr %accesedradius_from_Circle, align 4
  %2 = mul i64 3, %1
  %3 = load ptr, ptr %self1, align 8
  %accesedradius_from_Circle2 = getelementptr inbounds %main.gc..Circle.1, ptr %3, i32 0, i32 1
  %4 = load i64, ptr %accesedradius_from_Circle2, align 4
  %5 = mul i64 %2, %4
  ret i64 %5
}
...
entry:
  ...
  %2 = load ptr, ptr %accesedcenter_from_Circle2, align 8
...
entry:
  ...
  store ptr %Circle, ptr %0, align 8
