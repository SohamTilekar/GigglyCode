...
entry:
  %self1 = alloca ptr, align 4
  store ptr %self, ptr %self1, align 4
  %other_2 = alloca ptr, align 4
  store ptr %other_, ptr %other_2, align 4
  %0 = load ptr, ptr %self1, align 4
  %accesedx_from_Point = getelementptr inbounds %main.gc..Point.0, ptr %0, i32 0, i32 0
  %1 = load ptr, ptr %other_2, align 4
  %accesedx_from_Point3 = getelementptr inbounds %main.gc..Point.0, ptr %1, i32 0, i32 0
  %2 = load i64, ptr %accesedx_from_Point, align 8
  %3 = load i64, ptr %accesedx_from_Point3, align 8
  %4 = sub i64 %2, %3
  %5 = load ptr, ptr %self1, align 4
  %accesedy_from_Point = getelementptr inbounds %main.gc..Point.0, ptr %5, i32 0, i32 1
  %6 = load ptr, ptr %other_2, align 4
  %accesedy_from_Point4 = getelementptr inbounds %main.gc..Point.0, ptr %6, i32 0, i32 1
  %7 = load i64, ptr %accesedy_from_Point, align 8
  %8 = load i64, ptr %accesedy_from_Point4, align 8
  %9 = sub i64 %7, %8
...
entry:
  ...
  %25 = load i64, ptr %accesedx_from_Point, align 8
  %26 = load ptr, ptr %3, align 4
  %accesedy_from_Point = getelementptr inbounds %main.gc..Point.0, ptr %26, i32 0, i32 1
  %27 = load i64, ptr %accesedy_from_Point, align 8
  ...
  store i64 10, ptr %element, align 8
  %32 = load ptr, ptr %2, align 4
  %element2 = getelementptr i64, ptr %32, i64 1
  %33 = load i64, ptr %element2, align 8
  store i64 20, ptr %element2, align 8
  %34 = load ptr, ptr %2, align 4
  %element3 = getelementptr i64, ptr %34, i64 2
  %35 = load i64, ptr %element3, align 8
  store i64 30, ptr %element3, align 8
...
body:                                             ; preds = %cond
  ...
  %41 = load i64, ptr %element4, align 8
...
entry:
  ...
  %1 = load i64, ptr %val2, align 8
  store i64 %1, ptr %accesedvalue_from_Box, align 8
  ret void
}
...
entry:
  ...
  %0 = load ptr, ptr %self1, align 4
  %accesedvalue_from_Box = getelementptr inbounds %main.gc..Box, ptr %0, i32 0, i32 0
  %1 = load i64, ptr %accesedvalue_from_Box, align 8
  ret i64 %1
}
