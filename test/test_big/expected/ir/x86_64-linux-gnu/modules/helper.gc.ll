; ModuleID = 'modules..helper.gc..'
source_filename = "/mnt/soham/soham_code/GigglyCode/test/test_big/src/modules/helper.gc"
...
define i64 @modules..helper.gc..compute_sum(i64 %a, i64 %b) {
entry:
