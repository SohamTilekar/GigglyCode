...
@0 = private unnamed_addr constant [7 x i8] c"%f:%f\0A\00", align 1
@1 = private unnamed_addr constant [23 x i8] c"Subtract integers: %i\0A\00", align 1
@2 = private unnamed_addr constant [21 x i8] c"Subtract floats: %f\0A\00", align 1
...
entry:
  ...
  %2 = call i64 (ptr, ...) @printf(ptr @0, double %0, double %1)
...
entry:
  ...
  %2 = call i64 @subtract(i64 10, i64 5)
  %3 = call i64 (ptr, ...) @printf(ptr @2, i64 %2)
  ret i64 0
}
